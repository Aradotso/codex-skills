...
Auto-generated agent skills from the fastest-growing **OpenAI Codex** open source projects on GitHub, by [ara.so](https://ara.so).

A bot scans GitHub every 30 minutes for trending repos in the OpenAI Codex niche, ranks them by stars/day, and writes an installable `SKILL.md` for the top new one.

## Install all skills

```bash
npx skills add Aradotso/codex-skills
```

## Install a specific skill

```bash
npx skills add Aradotso/codex-skills --skill <skill-name>
```
...
| [codex-cli-delegation](skills/codex-cli-delegation/) | [install](https://skills.sh/aradotso/codex-skills/codex-cli-delegation) | [skills-directory/skill-codex](https://github.com/skills-directory/skill-codex) | 2026-05-17 |
| [claude-code-codex-delegation](skills/claude-code-codex-delegation/) | [install](https://skills.sh/aradotso/codex-skills/claude-code-codex-delegation) | [skills-directory/skill-codex](https://github.com/skills-directory/skill-codex) | 2026-05-17 |
| [skill-codex-delegation](skills/skill-codex-delegation/) | [install](https://skills.sh/aradotso/codex-skills/skill-codex-delegation) | [skills-directory/skill-codex](https://github.com/skills-directory/skill-codex) | 2026-05-17 |
...
| [nerv-break-gpt-jailbreak-framework](skills/nerv-break-gpt-jailbreak-framework/) | [install](https://skills.sh/aradotso/codex-skills/nerv-break-gpt-jailbreak-framework) | [lingbol088-spec/5.6-JAILBREAK-NERV-codex-instruct-5.6](https://github.com/lingbol088-spec/5.6-JAILBREAK-NERV-codex-instruct-5.6) | 2026-08-05 |
<!-- SKILL_INDEX -->
